...
Tags: store locator,locator,map,locations,google map,location finder,shop finder,store finder,zip code
License: GPL3
Required PHP: 5.3
...
[SLP](https://www.storelocatorplus.com/) | [Fully Managed](https://my.storelocatorplus.com)| [WordPress Plugins](https://wordpress.storelocatorplus.com)  | [Documentation](https://docs.storelocatorplus.com) | [Demo](https://demo.storelocatorplus.com)
...
* CHANGED [Experience Add On](https://wordpress.storelocatorplus.com/product/experience/) must be updated to version 4.9.14
* CHANGED [Power Add On](https://wordpress.storelocatorplus.com/product/power/) must be updated to version 4.9.14
* CHANGED Dropped support for the slp_edit_location_right_column filter, may affect older unsupported add ons.
* NOTE [Power](https://wordpress.storelocatorplus.com/product/power/) must be upgraded to 4.9.14
...
* IMPROVED new visual interface settings are coming -- like the loading locations indicator for [Premier Members](https://wordpress.storelocatorplus.com/product/premier-subscription/).
...
* IMPROVED added dozens of new [slplus shortcode options](https://docs.storelocatorplus.com/blog/tag/slplus/).
...
* CHANGED All translation files must come from [Translate.WordPress.Org](https://translate.wordpress.org/projects/wp-plugins/store-locator-le/stable) and live in wp-content/languages/plugins/store-locator-le/.
* CHANGED Legacy Enhanced Map scrollwheel, mapTypeControl, and scaleControl options are not longer supported.  Upgrade to the [Experience Add On](https://wordpress.storelocatorplus.com/product/experience/).
...
* PATCH Make associated stores post types self-correcting when using [Power Add On](https://wordpress.storelocatorplus.com/product/power/) features.
...
* PATCH Stop PHP warnings with [Power Add On](https://wordpress.storelocatorplus.com/product/power/) creating individual SEO pages.
* PATCH Bulk Delete Locations deletes associated SEO Pages created by [Power Add On](https://wordpress.storelocatorplus.com/product/power/).
