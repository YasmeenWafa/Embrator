...
<form class="jobpost-form" id="sjb-application-form" name="c-assignments-form"  enctype="multipart/form-data">
    <h3><?php echo apply_filters('sjb_job_application_form_title', esc_html__('', 'simple-job-board')); ?></h3>    
    <div class="row">
        <?php
        /**
        ...
        $sjb_attach_resume = '<div class="col-md-12">'
                . '<label for="applicant_resume">' . apply_filters('sjb_resume_label', __('Also you need to attach your resume/CV', 'simple-job-board')) . '<span class="sjb-required required">*</span><span class="hint">Microsoft Word or PDF only (5MB)</span></label>'
                . '</div>'
                . '<div class="col-md-12">
                                    <div class="form-group">'
        ...
        <?php if (0 === $total_sections) { ?>
            ...
            <div class="form-group" id="sjb-form-padding-button">
                <button class="btn btn-primary app-submit"><?php esc_html_e('Apply Now', 'simple-job-board'); ?></button>           
            </div>
            <?php if ( 0 === $total_sections ) { ?>
            </div>
        <?php } ?>
