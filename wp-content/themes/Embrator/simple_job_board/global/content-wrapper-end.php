...
switch( $template ) {
	...
	case 'twentysixteen' :
		...
		<section class="section section__branches" style="background-image: url( ' .  get_stylesheet_directory_uri() .'/src/assets/images/pages/Home/branches.png)" >
			  <h3>Embrator Branches</h3>
		  <h1>We have <span>100+</span> locations all over Egypt</h1>
		  <a class="branches__button" href="'.  get_sub_field("branches_button",5) .'">VIEW ALL BRANCHES</a>
		</section>
	  </div>';
	  break;
	default :
