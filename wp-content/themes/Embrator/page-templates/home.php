...
the_row(); 
$count = count(get_field('homepage_bannerslider'));
if($i === 1 ){
    $class= "active";
}else if($i === $count){
    $class= "lastSlide";
...
?>
    <figure
      class="bannerSlider-figure bannerSlider-figure--top <?php echo $class ?> slide0<?php echo $i?>"
    >
...
?>
<?php 
if (have_rows('homepage_bannerslider_2')): 
  $j = 1;
?>
<section class="bottom">
  <?php // loop through the rows of data
while (have_rows('homepage_bannerslider_2')):
the_row(); 
if($j === 1 ){
  $class= "active";
}else{
...
?>
    <figure
      class="bannerSlider-figure bannerSlider-figure--bottom <?php echo $class ?> slide0<?php echo $j?>"
      style="background-image: url(<?php echo $patternImage_url; ?> )"
    >
    <figure
    class="bannerSlider-product"
    style="background-image: url(<?php echo $productImage_url; ?> )"
    ></figure>
  </figure>
...
?>
  ...
  <figure class="collectionsSlider__image" style="background-image: url(<?php echo $collectionImage_url; ?> )">
    <div class="collectionsSlider__group">
      ...
      <figure
        class="collectionsSlider__nextButtonBg"
        style="background-image: url(<?php echo $nextButtonImage_url; ?> )"
        >
      </figure>
      <figure 
        class="collectionsSlider__prevButtonBg" 
        style="background-image: url(<?php echo $previousButtonImage_url; ?>)"
        >
      </figure>
    </div>
  </figure>
